    ...
    >
      ...
      <header className="absolute top-6 left-6 flex items-center">
        <div className="bg-white rounded-full shadow-md px-4 py-2 flex items-center gap-2">
          ...
          />
          <span className="text-red-600 font-bold text-lg">ETHMUMBAI</span>
        </div>
      </header>
      ...
      <div className="absolute top-6 right-6">
        ...
        <div className="md:hidden">
          ...
          {open && (
            <div className="absolute top-14 right-0 bg-white rounded-lg shadow-lg flex flex-col gap-3 p-4">
              <a
                href="#"
